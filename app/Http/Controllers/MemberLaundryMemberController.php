...
class MemberLaundryMemberController extends Controller
{
    public function index(): View
    {
        ...
        $laundry_member = DB::table('datalaundrymember')
            ...
            ->get();
        return view('levelMember.laundryMember.index', compact('laundry_member'));
    }
    ...
    public function show(string $id): View
    {
        $laundry_member = DB::table('datalaundrymember')
            ...
            ->first();
        return view('levelMember.laundryMember.show', compact('laundry_member'));
    }
}
